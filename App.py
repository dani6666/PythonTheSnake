...
class App:
    ...
    def simulate(self):
        ...
        if snake_head_pos == self.apple_pos:
            ...
            while self.apple_pos in self.snake.get_slots_occupied_by_body() or \
                    self.apple_pos == self.snake.head.get_pos():
    ...
    def render(self):
        ...
        for bp in self.snake.body:
            ...
            sprite.set_colorkey((255, 0, 255))
            self.window.blit(sprite, (bp.get_pos()[0] * 40, bp.get_pos()[1] * 40))
        ...
        self.window.blit(sprite, (self.snake.head.get_pos()[0] * 40, self.snake.head.get_pos()[1] * 40))
